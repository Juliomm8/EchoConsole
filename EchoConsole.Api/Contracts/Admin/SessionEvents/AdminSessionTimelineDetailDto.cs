...
public sealed class AdminSessionTimelineDetailDto
{
    ...
    public IReadOnlyList<AdminSessionTimelineEventDto> Events { get; set; } =
        Array.Empty<AdminSessionTimelineEventDto>();
}